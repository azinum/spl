...
" Language keywords
syntax keyword Keywords include print const let fn if else while and or not eq neq lshift rshift sizeof store64 store32 store16 store8 load64 load32 load16 load8 enum struct cast static_assert at deref
